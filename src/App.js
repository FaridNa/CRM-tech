...
function App() {
    ...
    useEffect(() => {
        if (window.bx24) {
           ...
           //setUser({ID: "83", NAME: 'Олег', LAST_NAME: 'Кирюшкин', SECOND_NAME : 'Юрьевич', UF_DEPARTMENT: [51]})
           setUser({ID: "277", NAME: 'Фёдор', LAST_NAME: 'Клочков', SECOND_NAME : 'Викторович', UF_DEPARTMENT: [15]})
        }
        getAllReq()
        getReq()
        getUsers()
